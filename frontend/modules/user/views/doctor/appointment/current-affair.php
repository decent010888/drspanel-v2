...
$this->title = Yii::t('frontend','Doctor  :: Current Status');
                        ...
                        <?php if(!empty($Shifts)) { ?>
                            ...
                            <div id="shift-current-appointment-load">
                                <div class="doc-boxespart-book" id="shift-current-appointment">
                                    <?php echo $this->render('/common/_current_bookings',['bookings'=>$appointments,'type'=>$type,'userType'=>'doctor','is_started'=>$is_started,'is_completed'=>$is_completed,'is_cancelled'=>$is_cancelled,'schedule_id'=>$schedule_id,'shift_id'=>$shift_id,'doctor'=>$doctor]); ?>
