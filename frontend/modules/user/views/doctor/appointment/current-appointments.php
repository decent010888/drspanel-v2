                ...
                <div class="col-md-12" id="appointments_section">
                    ...
                    <div class="hospitals-detailspt appointment_list">
                        ...
                        <div id="appointment_shift_slots">
                            <?php
                            echo $this->render('/common/_appointment_shift_slots',['appointments'=>$appointments,'current_shifts'=>$current_shifts,'doctor'=>$doctor,'bookings'=>$bookings,'type'=>$type,'userType'=>'doctor','message'=>($message)?$message:'']);
                            ?>
                        </div>
                    </div>
                </div>
