...
$addressUrl="'".$baseUrl."/hospital/get-shift-details'";
$js="
...
if(count($appointments)>0) {
    ...
    foreach ($appointments as $key => $appointment) {
        $shiftAdminStatus=DrsPanel::getProfileStatus($appointment['doctor_id']);
        ?>
        <div class="morning-parttiming">
            <div class="main-todbox">
                <div class="pull-left">
                    <div class="moon-cionimg ">
                        <img src="<?php echo $baseUrl?>/images/doctor-profile-icon1.png" alt="image">
                        <span> <strong class="hospota_add">
                                <?php echo DrsPanel::getUserName($appointment['doctor_id'])?></strong>
                        </span>
                    </div>
                </div>
                <?php if($loginUser->admin_status == User::STATUS_ADMIN_LIVE_APPROVED && $shiftAdminStatus == User::STATUS_ADMIN_LIVE_APPROVED) { ?>
                    <div class="pull-right">
                        <label class="switch ">
                            <input type="checkbox" <?php echo ($appointment['booking_closed'] == 0)?'checked':''; ?> id="toggle-<?php echo $appointment['schedule_id']?>">
                            <span id="back-color_<?php echo $appointment['schedule_id']; ?>" class="slider-toggle round shift-toggle" data-shift="<?php echo $appointment['schedule_id']; ?>"></span>
                        </label>
                    </div>
                <?php } ?>
            </div>
            <div class="main-todbox no-pd">
                <div class="addressText">
                    <div class="pull-left">
                        <div class="moon-cionimg">
                            <p><img src="<?php echo $baseUrl ?>/images/doctor-profile-icon6.png">
                                <?php echo DrsPanel::getDoctorSpeciality($appointment['doctor_id']); ?>
                            </p>
                        </div>
                    </div>
                    <div class="pull-right">
