            ...
            <?php foreach ($scheduleslist as $key => $value) {
                ...
                <div class="morning-parttiming">
                    ...
                    <div class="main-todbox no-pd">
                        <div class="pull-left">
                            <div class="moon-cionimg "><img src="<?php echo $baseUrl?>/images/doctor-profile-icon3.png" alt="image"> <span> <strong class="hospota_add"> <?= $address->address; ?></strong></span> </div>
                        </div>
