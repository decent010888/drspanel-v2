...
$updateAppointmentStatus="'".$baseUrl."/hospital/appointment-status-update'";
$updateShift="'".$baseUrl."/hospital/current-appointment-shift-update'";
$js="
...
?>
<div class="youare-text">Current Booking Affair for Doctor: <?php echo DrsPanel::getUserName($doctor->id);?></div>
                ...
                <div class="col-md-12" id="appointments_section">
                    ...
                    <div class="hospitals-detailspt appointment_list">
                        ...
                        <div class="doc-timingslot">
                            <ul>
                                <?php echo $this->render('/common/_shifts',['shifts'=>$Shifts,'current_shifts'=>$current_shifts,'doctor'=>$doctor,'type'=>$type,'userType'=>'hospital']);?>
                            </ul>
                        </div>
                        ...
                        <?php if(!empty($Shifts)) { ?>
                            ...
                            <div id="shift-current-appointment-load">
                                <div class="doc-boxespart-book" id="shift-current-appointment">
                                    <?php echo $this->render('/common/_current_bookings',['bookings'=>$appointments,'type'=>$type,'userType'=>'hospital','is_started'=>$is_started,'is_completed'=>$is_completed,'is_cancelled'=>$is_cancelled,'schedule_id'=>$schedule_id,'shift_id'=>$shift_id,'doctor'=>$doctor]); ?>
