...
<div class="youare-text">Appointments for Doctor: <?php echo DrsPanel::getUserName($doctor->id);?></div>
                ...
                <div class="col-md-12" id="appointments_section">
                    <div class="today-appoimentpart">
                        <div id="appointment_date_select" class="appointment_date_select mx-auto calendra_slider">
                            ...
                            echo $this->render('/common/_appointment_date_slider',['dates_range'=>$dates_range,'doctor_id'=>$doctor->id,'type'=>$type,'userType'=>'hospital']);
                            ?>
                        </div>
                        <div class="calender_icon_main pull-right">
                            <?php echo DatePicker::widget([
                                ...
                                'pluginEvents' => [
                                    "change" => "function(){
                                            bookingsDate($('#appointment-date').val(),'$type','hospital',$doctor->id);
                                        }",
                                ],
                            ]);
                            ?>
                    ...
                    <div class="hospitals-detailspt appointment_list">
                        ...
                        <div id="appointment_shift_slots">
                            <?php
                            echo $this->render('/common/_appointment_shift_slots',['appointments'=>$appointments,'current_shifts'=>$current_shifts,'doctor'=>$doctor,'bookings'=>$bookings,'type'=>$type,'userType'=>'hospital']);
                            ?>
                        </div>
                    </div>
                </div>
