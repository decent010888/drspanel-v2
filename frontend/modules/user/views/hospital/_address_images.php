        ...
        <div class="address_gallery gallary_images">
            <?php foreach($addressImages as $addressImage) { ?>
                ...
                <div class="address_img_attac">
                    ...
                    <span class="address_image_remove remove" id="<?php echo $addressImage->id; ?>" data-keyid="<?php echo $addressImage->id; ?>" data-usertype="hospital"><i class="fa fa-trash"></i></span>
                </div>
            <?php } ?>
        </div>
