        ...
        <div class="modal-body" id="updatereminder">
            <div class="col-md-12 mx-auto">
                ...
                <input type="hidden" name="hiddenEndDate" value="<?php echo $doctorData['appointment_date']; ?>" id="hiddenEndDate"/>
                    ...
                    <?= $form->field($reminder, 'reminder_time')->textInput(['autocomplete'=>'off',
                        'placeholder' => Yii::t('db','Time'),'readonly'=> false,
                        'class'=>'reminder_time_check form-control','onchange' => 'shiftReminderValue("reminder-form");'])
                        ->label(false); ?>
                    </div>
