            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="pace-right">
                        <h4><a href="<?php echo $baseUrl . '/doctor/' . $doctor['userProfile']['slug'] ?>"><?= $doctor['userProfile']['prefix'] ?> <?= $doctor['userProfile']['name'] ?></a></h4>
                        ...
                        <div class="next_appointment">
                            ...
                            <?php
                            if ($appointment['status'] == UserAppointment::STATUS_CANCELLED) {
                    ...
                    <div class="doc-listboxes">
                        ...
                        <div class="bookappoiment-btn pull-right">
                            <?php
                            if ($appointment['status'] == UserAppointment::STATUS_CANCELLED || $appointment['status'] == UserAppointment::STATUS_COMPLETED) {
