                ...
                <div class="col-md-12" id="appointments_section">
                    ...
                    <div class="hospitals-detailspt appointment_list">
                        ...
                        <div id="appointment_shift_slots">
                            <?php
                            echo $this->render('/common/_appointment_shift_slots',['appointments'=>$appointments,'current_shifts'=>$current_shifts,'doctor'=>$doctor,'type'=>$type,'slots'=>$slots,'userType'=>'attender','message'=>($message)?$message:'']);
                            ?>

                            <?php
                           /* echo $this->render('_appointment_shift_slots',['appointments'=>$appointments,'current_shifts'=>$current_shifts,'doctor'=>$doctor,'type'=>$type,'slots'=>$slots]);*/
                            ?>
                        </div>
                    </div>
                </div>
