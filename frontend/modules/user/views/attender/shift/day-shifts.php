...
$updateStatus="'".$baseUrl."/attender/update-shift-status'";
$this->title = Yii::t('frontend','DrsPanel :: Timing');
$getlist="'".$baseUrl."/attender/ajax-address-list'";
$js="
    ...
    $('#main-js-preloader').show();   
      ...
      if(status=='true'){
       ...
       $.ajax({
          method:'POST',
          url: $updateStatus,
          data: {id:shift_id,status:statusValue,date:date,doctor_id:$doctor->id}
        })
      .done(function( msg ) { 
            getShiftSlots($doctor->id,'attender','shifts',date,0,'+');
            setTimeout(function() {
                ...
                <div class="col-md-8 mx-auto" id="appointments_section">
                    <div class="today-appoimentpart">
                        <div id="appointment_date_select" class="appointment_date_select mx-auto calendra_slider">
                            ...
                            echo $this->render('/common/_appointment_date_slider',['dates_range'=>$dates_range,'doctor_id'=>$doctor->id,'type'=>'shifts','userType'=>'attender']);
                            ?>
                        </div>
                        ...
                        <div class="calender_icon_main pull-right">
                            <?php echo DatePicker::widget([
                                ...
                                'pluginEvents' => [
                                    "change" => "function(){
                                            bookingsDate($('#appointment-date').val(),'shifts','attender',$doctor->id);
                                        }",
                                ],
                            ]);
                            ?>
