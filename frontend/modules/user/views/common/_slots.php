...
$getlist="'".$baseUrl."/$userType/booking-confirm'";
$js="
    ...
    <div class="row">
        <?php if(count($slots)>0){
            foreach ($slots as $key => $slot) {
                ...
                <div class="col-sm-3 col-lg-3 col-md-4 col-sm-6">
                    <div class="token_allover token_allover_book <?php echo $class_click; ?>" id="slot-<?php echo $slot['id']; ?>">
                        ...
                        <div class="token-rightdoctor">
                            <div class="token-timingdoc <?php echo $token_class; ?>">
                                ...
                                <span class="time-btnpart"> <?php echo $slot['shift_name']; ?></span> 
                            </div>
                        </div>
                    </div>
                </div>
