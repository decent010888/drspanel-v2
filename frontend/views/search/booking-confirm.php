...
$('.booking_confirm_step1').on('click',function(){
  ...
  if(ne == 1 || pe == 1 || ge == 1){
    ...
    $.ajax({
        method:'POST',
        url: $getlist,
        data: {doctor_id:doctor_id,slot_id:slot_id,name:name,phone:phone,gender:gender}
    })
   .done(function( msg ) { 
    if(msg){
    ...
    <div class="col-md-12 mx-auto">
        ...
        <div class="workingpart book-confirm cls-2">
            <div class="form-group">
                ...
                <div class="pull-right"> <a tabindex="-1" href="#" class="time-bg"><?php echo date('h:i a',$slot->start_time); ?> - <?php echo date('h:i a',$slot->end_time); ?> </a> </div>
            </div>
        </div>
        <form class="appoiment-form-part mt-0 mt-nill">
            <div tabindex="0" class="btdetialpart mt-0" id="user_name_div">
                <input type="text" id="user_name" name="name" placeholder="Name" style="text-transform: capitalize;">
            </div>
