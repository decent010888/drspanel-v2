...
$cityAreaUrl = "'" . $backend . "/doctor/city-area-list'";
$addmoreshift = "'" . $backend . "/doctor/add-more-shift'";
$mapAreaUrl = "'" . $backend . "/doctor/map-area-list'";
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    $form->field($modelAddress, 'name')->textInput(
                                            ['placeholder' => 'Hospital/Clinic Name', 'readOnly' => ($disable_field == 0) ? false : true, 'class' => 'form-control'])->label(false)
                                    ?>
                                </div>

                                <div class="col-md-6">
                                    <?php
                                    echo $form->field($modelAddress, 'state')->widget(Select2::classname(), [
                                        'data' => $statesList,
                                        'size' => Select2::SMALL,
