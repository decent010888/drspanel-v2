...
<div class="row" style="margin-bottom:10px; ">
    <div class="col-md-2 col-sm-6 col-xs-12">
      ...
      <div class="col-md-2 col-sm-6 col-xs-12">
        <button type="button" id="get_edu_modal" class="btn btn-block btn-warning">Education</button>
    </div>
    <div class="col-md-2 col-sm-6 col-xs-12">
        <button type="button" id="get_exp_modal" class="btn btn-block btn-success">Experience</button>
    </div>
     <div class="col-md-2 col-sm-6 col-xs-12">
        <button type="button" class="btn btn-block btn-primary" onclick="location.href='<?php echo yii\helpers\Url::to(['doctor/attender-list?id='.$userProfile->user_id]); ?>';">My Attenders</button>
    </div>

    <div class="col-md-2 col-sm-6 col-xs-12">
        <button type="button" class="btn btn-block btn-info" onclick="location.href='<?php echo yii\helpers\Url::to(['doctor/requested-hospital?id='.$userProfile->user_id]); ?>';">Hospital Requests</button>
    </div>

    <div class="col-md-2 col-sm-6 col-xs-12">
        <button type="button" class="btn btn-block bg-orange" onclick="location.href='<?php echo yii\helpers\Url::to(['doctor/my-shifts?id='.$userProfile->user_id]); ?>';">Shifts</button>
    </div>
...
<div class="row" style="margin-bottom:10px; ">
   ...
   <!--  <div class="col-md-2 col-sm-6 col-xs-12">
        <button type="button" class="btn btn-block btn-danger" onclick="location.href='<?php /*echo yii\helpers\Url::to(['doctor/my-shifts?id='.$userProfile->user_id]); */?>';">My Shifts </button>
    </div>-->
